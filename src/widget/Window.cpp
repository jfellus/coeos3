...
Window::Window() : Widget(NULL){
	...
	gtk_notebook_append_page(GTK_NOTEBOOK(gtk_builder_get_object(builder, "rightpane")), docBrowser->widget, gtk_label_new("Doc"));

	properties = new PropertiesForm();
	gtk_notebook_append_page(GTK_NOTEBOOK(gtk_builder_get_object(builder, "rightpane")), properties->widget, gtk_label_new("Properties"));

//	infoform = new InfoForm();
//	gtk_notebook_append_page(GTK_NOTEBOOK(gtk_builder_get_object(builder, "rightpane")), infoform->widget, gtk_label_new("Infos"));
